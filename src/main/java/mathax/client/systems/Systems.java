...
public class Systems {
    ...
    public static void save(File folder) {
        ...
        MatHax.LOG.info(MatHax.LOG_PREFIX + "Systems saved in {} milliseconds.", Utils.getCurrentTimeMillis() - start);
    }
    ...
    public static void load(File folder) {
        ...
        MatHax.LOG.info(MatHax.LOG_PREFIX + "Systems loaded in {} milliseconds.", Utils.getCurrentTimeMillis() - start);
    }
